...
mps = True # enables mps fo ARM Macs
multi_gpu = False # whether to use multi gpu
ngpu = 1 # number of GPUs to use. Do remember to set multi_gpu to True!
workers = 0 # number of data loading workers

# training process
displayInterval = 23 # interval to be print the train loss
valInterval = 46 # interval to val the model loss and accuray
saveInterval = 46 # interval to save model
...
lr = 0.0003 # learning rate for Critic, not used by adadealta
